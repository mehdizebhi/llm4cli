...
@Command(name = "Llm4cli", mixinStandardHelpOptions = true, version = "Llm4cli 0.0.1",
        description = "LLM Command line tool for chatting with various models in terminal.")
class Main implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        if (models.isEmpty()) {
            System.err.println("Invalid vendor name: " + vendorName + ". Available vendors: " + availableModels().keySet());
            return 1;
        ...
        ChatLanguageModel model = switch (vendorName) {
        ...
        System.out.println(model.chat(prompt));
    ...
    private GoogleAiGeminiChatModel gemini(String modelName) {
